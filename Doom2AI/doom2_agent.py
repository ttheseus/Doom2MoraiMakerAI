...
trainX = pickle.load(open("doom2_trainX.p", "rb"))#40 (width) x 15 (height) x 34 (SMB entitites) (state)
trainY = pickle.load(open("doom2_trainY.p", "rb"))#40 (width) x 15 (height) x 32 (SMB entities except the player and the flat) (value of the AI making a particular addition)
...
model.save("doom2_test_model.tflearn")
