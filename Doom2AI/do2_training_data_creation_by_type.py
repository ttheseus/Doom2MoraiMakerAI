...
#Load Doom Levels
for levelFile in glob.glob(".\\Doom2_Levels\\*.txt"): # *.txt for all, change to test later
...
pickle.dump(X, open("doom2_trainX.p", "wb"))
pickle.dump(Y, open("doom2_trainY.p", "wb")) # change to doom_test later for test data, run doom_agent with train, run doom_agent_test with test
